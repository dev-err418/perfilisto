    ...
    >
      ...
      >
        <div className="bg-[#171717] p-6 text-white sm:p-7">
          <p className="text-4xl font-semibold tracking-tight text-[var(--primary)] sm:text-5xl">
            {copy.stat}
          </p>
        ...
        <div className="relative p-6 sm:p-8">
          ...
          <button
            type="button"
            onClick={() => router.push("/")}
            className="mt-6 inline-flex h-12 w-full items-center justify-center rounded-xl bg-black/[0.06] px-4 text-[15px] font-semibold text-[#141414] hover:bg-black/[0.09]"
          >
            {copy.dashboard}
          </button>
          <button
            type="button"
            onClick={onStay}
            className={`${PRIMARY_TINT_BUTTON_CLASS} mt-3 inline-flex h-12 w-full items-center justify-center rounded-xl px-4 text-[15px] font-semibold`}
          >
            {copy.claim}
          </button>
        </div>
