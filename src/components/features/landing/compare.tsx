...
const Status = ({
  ...
  <span className="inline-flex items-center gap-2.5">
    ...
    <span className="text-[15px] leading-6 font-medium text-[#141414] sm:text-base">
      {children}
    </span>
  </span>
);
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-12 overflow-x-auto rounded-[28px] border border-black/[0.06] bg-[#f7f7f7]">
          <table className="w-full min-w-[640px] border-collapse text-left">
            ...
            <thead>
              <tr className="border-b border-black/[0.06]">
                ...
                <th className="px-4 py-5 text-base font-semibold text-[#141414] sm:px-6 sm:text-lg">
                  <span className="inline-flex items-center gap-2.5">
            ...
            <tbody>
              {copy.rows.map((row) => (
                ...
                >
                  <th
                    scope="row"
                    className="px-5 py-5 text-[15px] font-medium text-[#717171] sm:px-8 sm:text-base"
                  >
                    {row.label}
                  </th>
